...
const set_password_dto_1 = require("../account/dto/set-password.dto");
let AuthController = class AuthController {
    ...
    login(credentialsDto) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.authService.authenticate(credentialsDto.email, credentialsDto.password);
        });
    }
    resetPassword(email) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    setPassword(passwordSetDto) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.authService.setPassword(passwordSetDto);
        });
    }
};
__decorate([
...
__decorate([
    common_1.Get('password-reset/:email'),
